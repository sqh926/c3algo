...
| [`c3algo::collections::avltree`](src/collections/avltree.c3)                 | A sorted set that also answers the $k$-th smallest key, $\lvert \lbrace i : a_i \le x \rbrace \rvert$ and the two neighbours of $x$, in $O(\log n)$.                                              |
